...
opt.trainingAlgorithm = 'supervised_binary_labels'
opt.labelCount = labelCount
opt.maxTimeInSeconds = 3600
...
netD:add(SpatialConvolution(ndf * 8, 1 + labelCount, 4, 4))
netD:add(nn.Sigmoid())
-- state size: 1 x 1 x 1
netD:add(nn.View(1 + labelCount):setNumInputDims(3))
-- state size: 1
