...
print("Loading data ...")
dataset = load_supervised_image_dataset_in_memory('img', 'labels.txt')
...
netD:add(SpatialConvolution(ndf * 8, 2, 4, 4))
netD:add(nn.Sigmoid())
-- state size: 2 x 2 x 2
netD:add(nn.View(2):setNumInputDims(3))
-- state size: 2
